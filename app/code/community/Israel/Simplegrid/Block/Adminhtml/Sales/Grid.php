<?php
class Israel_Simplegrid_Block_Adminhtml_Sales_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('israel_simplegrid_grid');
    ...
    {
        $helper = Mage::helper('israel_simplegrid');
